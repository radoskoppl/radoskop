...
def main() -> int:
    parser = argparse.ArgumentParser(description="Radoskop Rzeszów (stub)")
    ...
    print("[Rzeszów] stub scraper — writing empty valid outputs.")
