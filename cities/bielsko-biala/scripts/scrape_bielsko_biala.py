#!/usr/bin/env python3
"""
Radoskop Bielsko-Biała — STUB scraper.
...
BIP URL: https://bip.bielsko-biala.pl/
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Radoskop Bielsko-Biała (stub)")
    ...
    print("[Bielsko-Biała] stub scraper — writing empty valid outputs.")
