#!/usr/bin/env python3
"""
Scraper danych głosowań Rady Miasta Tychy.

UWAGA: Uruchom lokalnie — sandbox Cowork blokuje domeny

Źródło: tychy.esesja.pl
eSesja to platforma do głosowań elektronicznych.

Struktura eSesja:
  1. Archiwum glosowan: https://tychy.esesja.pl/glosowania
...
ESESJA_BASE = "https://tychy.esesja.pl"
...
# Source: BIP Tychy, portal samorządowy
...
def main():
    parser = argparse.ArgumentParser(description="Scraper Rady Miasta Tychy (eSesja)")
