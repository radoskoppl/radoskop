#!/usr/bin/env python3
"""
Scraper danych głosowań Rady Miasta Kielce.

UWAGA: Uruchom lokalnie — sandbox Cowork blokuje domeny

Źródło: kielce.esesja.pl
eSesja to platforma do głosowań elektronicznych.

Struktura eSesja:
  1. Archiwum glosowan: https://kielce.esesja.pl/glosowania
...
ESESJA_BASE = "https://kielce.esesja.pl"
...
# Source: BIP Kielce, portal samorządowy
...
def main():
    parser = argparse.ArgumentParser(description="Scraper Rady Miasta Kielce (eSesja)")
