#!/usr/bin/env python3
"""
Radoskop Kielce — eSesja scraper (thin wrapper around scripts/lib_esesja.py).
...
if __name__ == "__main__":
    raise SystemExit(EsesjaScraper(
        base_url="https://kielce.esesja.pl",
        kadencje=KADENCJE,
        councilors=COUNCILORS,
    ).run_cli(prog_name="Radoskop Kielce (https://kielce.esesja.pl)"))
