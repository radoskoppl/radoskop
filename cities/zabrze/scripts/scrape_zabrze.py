...
BIP URL: https://bip.um.zabrze.pl/
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Radoskop Zabrze (stub)")
    ...
    print("[Zabrze] stub scraper — writing empty valid outputs.")
