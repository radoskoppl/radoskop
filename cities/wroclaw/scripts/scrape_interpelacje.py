#!/usr/bin/env python3
"""
Scraper interpelacji i zapytań radnych z BIP Wrocław.

Źródło: https://bip.um.wroc.pl/interpelacje/szukaj?term_id=X&perPage=25&page=N

Lista: tabele <th>label</th><td>value</td>
Detail: /interpelacja/{id}/{slug} — daty, PDF-y (treść + odpowiedź)
...
KADENCJE = {
    ...
    "VII":  {"term_id": 2, "label": "VII kadencja (2014–2018)"},
    "VI":   {"term_id": 1, "label": "VI kadencja (2010–2014)"},
}

HEADERS = {
    "User-Agent": "Radoskop/1.0 (https://wroclaw.radoskop.pl; kontakt@radoskop.pl)",
    "Accept": "text/html",
}
...
def main():
    parser = argparse.ArgumentParser(
        description="Scraper interpelacji i zapytań radnych z BIP Wrocław"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--kadencja", default="IX",
        help="Kadencja: IX, VIII, VII, VI lub 'all' (domyślnie: IX)"
    )
    parser.add_argument(
