#!/usr/bin/env python3
"""
Scraper danych głosowań Rady Miasta Radom.

UWAGA: Uruchom lokalnie — sandbox Cowork blokuje domeny

Źródło: radom.esesja.pl
eSesja to platforma do głosowań elektronicznych.

Struktura eSesja:
  1. Archiwum glosowan: https://radom.esesja.pl/glosowania
...
ESESJA_BASE = "https://radom.esesja.pl"
...
# Source: BIP Radom, portal samorządowy
...
def main():
    parser = argparse.ArgumentParser(description="Scraper Rady Miasta Radom (eSesja)")
