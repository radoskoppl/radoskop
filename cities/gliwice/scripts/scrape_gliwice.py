...
def main() -> int:
    parser = argparse.ArgumentParser(description="Radoskop Gliwice (stub)")
    ...
    print("[Gliwice] stub scraper — writing empty valid outputs.")
